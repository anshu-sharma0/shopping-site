...
const LocalCart = () => {
    ...
    const { data: product, isLoading, isPending, isError, error } = useQuery({
        queryKey: ['products'],
        queryFn: fetchProducts,
        // staleTime: 10000, // 5 seconds
        // cacheTime: 10000, // 5 seconds
    ...
    console.log({product, isLoading, isPending, isError, error})
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 bg-white rounded-2xl shadow p-6 overflow-x-auto">
                    ...
                    <table className="w-full table-auto text-left border-separate border-spacing-y-4">
                        ...
                        <tbody>
                            {product?.cartData?.items && product?.cartData?.items.map((item) => (
